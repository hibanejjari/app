...
import io
import tempfile
from pages import Report_Insights  # <-- Add your custom page module

st.set_page_config(layout="wide")

# Sidebar navigation
st.sidebar.title("📂 Navigation")
page = st.sidebar.radio("Choose a section:", ["Main Dashboard", "Report Insights"])

if page == "Report Insights":
    Report_Insights.app()
